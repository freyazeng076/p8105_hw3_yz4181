...
accel_df = 
  ...
  select("weekday_weekend", "week", "day_id", everything())
```
The table includes 35 rows and 1444 columns. Two variables "day" and "weekday_weekend" are character. "week", "day_id", and all activity variables are numeric.
