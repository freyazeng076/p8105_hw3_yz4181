...
![](hw3_yz4181_files/figure-gfm/unnamed-chunk-3-1.png)<!-- --> From the
plot, we notice that there are two aisle which are being ordered most.
...
The table of mean hour of the day includes 2 rows which are ‘Pink Lady
...
good”. The distribution of data value for “Good” is most widespread
among all responses, In 2010, the mean value of data value is also
...
![](hw3_yz4181_files/figure-gfm/unnamed-chunk-12-1.png)<!-- --> Figure 3
shows the total activity in each day over 5 weeks. There is no apparent
trend over the weeks. Most of the total activity in a day fall between
300000 and 500000.
...
![](hw3_yz4181_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
